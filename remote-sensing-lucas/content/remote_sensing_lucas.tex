...
simplicity. SMOTE was selected for being a the most widely used oversampler
...
methods}. Accordingly, models with no oversampling present the highest accuracy
...
application based on the LUCAS, a highly imbalanced multi-class dataset.
