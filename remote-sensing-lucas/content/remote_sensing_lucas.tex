...
LUCAS (Land Use/Cover Area frame Survey) dataset, is compared to other
oversamplers using a variety of classifiers.
...
Variational Semi-Supervised Learning to deal with class imbalance. Their method shows
