...
different factors, such as data quality and uncertainty. In this
...
% changed "more specifically" to "as such" simply because there's already the
% same expression in the start of the following subsection

% EDIT - Missing reference 176, 177
...
% EDIT - Missing references for classifiers
