...
\begin{table}[H]
	\centering
	\csvautobooktabular{../analysis/dataset_descrip.csv}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{../analysis/mean_scores.csv}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{../analysis/mean_ranking.csv}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{../analysis/model_mean_ranking.csv}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{../analysis/mean_perc_diff_scores.csv}
