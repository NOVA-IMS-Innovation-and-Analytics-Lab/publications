"""sports-betting-beating-the-bookmakers-with-machine-learning file for ensuring the package is executable
as `sports-betting-beating-the-bookmakers-with-machine-learning` and `python -m sports_betting_beating_the_bookmakers_with_machine_learning`
"""
import importlib
