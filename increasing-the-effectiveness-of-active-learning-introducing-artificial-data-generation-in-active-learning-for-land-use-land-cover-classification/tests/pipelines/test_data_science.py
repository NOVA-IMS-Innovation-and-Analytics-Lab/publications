import pandas as pd
import pytest
from increasing_the_effectiveness_of_active_learning_introducing_artificial_data_generation_in_active_learning_for_land_use_land_cover_classification.pipelines.data_science.nodes import split_data
