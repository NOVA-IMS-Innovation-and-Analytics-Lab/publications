"""increasing-the-effectiveness-of-active-learning-introducing-artificial-data-generation-in-active-learning-for-land-use-land-cover-classification file for ensuring the package is executable
as `increasing-the-effectiveness-of-active-learning-introducing-artificial-data-generation-in-active-learning-for-land-use-land-cover-classification` and `python -m increasing_the_effectiveness_of_active_learning_introducing_artificial_data_generation_in_active_learning_for_land_use_land_cover_classification`
"""
import importlib
