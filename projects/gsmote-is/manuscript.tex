...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig5}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig6}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig7}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig8}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig10}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig11}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig13}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=12cm, keepaspectratio]{./artifacts/fig14}
...
{./artifacts/datasets_summary.csv}
...
{./artifacts/perc_diff_scores.csv}
