"""large-language-models-for-biomedical-applications file for ensuring the package is executable
as `large-language-models-for-biomedical-applications` and `python -m large_language_models_for_biomedical_applications`
"""
import importlib
