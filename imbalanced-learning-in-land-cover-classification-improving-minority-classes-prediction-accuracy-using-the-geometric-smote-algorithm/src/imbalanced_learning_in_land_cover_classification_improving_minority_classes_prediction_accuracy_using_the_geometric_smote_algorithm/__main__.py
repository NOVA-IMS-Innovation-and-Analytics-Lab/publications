"""imbalanced-learning-in-land-cover-classification-improving-minority-classes-prediction-accuracy-using-the-geometric-smote-algorithm file for ensuring the package is executable
as `imbalanced-learning-in-land-cover-classification-improving-minority-classes-prediction-accuracy-using-the-geometric-smote-algorithm` and `python -m imbalanced_learning_in_land_cover_classification_improving_minority_classes_prediction_accuracy_using_the_geometric_smote_algorithm`
"""
import importlib
