import pandas as pd
import pytest
from imbalanced_learning_in_land_cover_classification_improving_minority_classes_prediction_accuracy_using_the_geometric_smote_algorithm.pipelines.data_science.nodes import split_data
