...
class ImbalancedDatasets(Datasets):
    ...
    def download(self):
        ...
        super(ImbalancedDatasets, self).download()
    ...
    def fetch_breast_tissue(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, '00192/BreastTissue.xls')
    ...
    def fetch_ecoli(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'ecoli/ecoli.data')
    ...
    def fetch_glass(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'glass/glass.data')
    ...
    def fetch_haberman(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'haberman/haberman.data')
        data = pd.read_csv(url, header=None)
    ...
    def fetch_heart(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'statlog/heart/heart.dat')
        data = pd.read_csv(url, header=None, delim_whitespace=True)
    ...
    def fetch_iris(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'iris/bezdekIris.data')
        data = pd.read_csv(url, header=None)
    ...
    def fetch_libras(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'libras/movement_libras.data')
        data = pd.read_csv(url, header=None)
    ...
    def fetch_liver(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'liver-disorders/bupa.data')
        data = pd.read_csv(url, header=None)
    ...
    def fetch_segmentation(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'statlog/segment/segment.dat')
        data = pd.read_csv(url, header=None, delim_whitespace=True)
    ...
    def fetch_vehicle(self):
        ...
        for letter in ascii_lowercase[0:9]:
            url = urljoin(self.UCI_ML_DBS, 'statlog/vehicle/xa%s.dat') % letter
    ...
    def fetch_wine(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'wine/wine.data')
        data = pd.read_csv(url, header=None)
    ...
    def fetch_new_thyroid_1(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRlowerThan9/'), 'new-thyroid1.zip')
    ...
    def fetch_new_thyroid_2(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRlowerThan9/'), 'new-thyroid2.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_cleveland(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p2/'), 'cleveland-0_vs_4.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_dermatology(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p3/'), 'dermatology-6.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_led(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p2/'), 'led7digit-0-2-4-5-6-7-8-9_vs_1.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_page_blocks_0(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRlowerThan9/'), 'page-blocks0.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_page_blocks_1_3(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p1/'), 'page-blocks-1-3_vs_4.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_vowel(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p1/'), 'vowel0.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_yeast_1(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRlowerThan9/'), 'yeast1.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_yeast_3(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRlowerThan9/'), 'yeast3.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_yeast_4(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p1/'), 'yeast4.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_yeast_5(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p1/'), 'yeast5.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_yeast_6(self):
        ...
        """
        url = urljoin(join(self.KEEL, 'imb_IRhigherThan9p1/'), 'yeast6.zip')
        zipped_data = requests.get(url).content
...
class BalancedDatasets(Datasets):
    """Class to download, transform and save binary class balanced datasets."""
    ...
    def fetch_banknote_authentication(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, '00267/data_banknote_authentication.txt')
        data = pd.read_csv(url, header=None)
        data.rename(columns={4: 'target'}, inplace=True)
        return data
    ...
    def fetch_arcene(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'arcene')
        data, labels = [], []
    ...
    def fetch_audit(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, '00475/audit_data.zip')
        zipped_data = requests.get(url).content
    ...
    def fetch_spambase(self):
        ...
        """
        url = urljoin(self.UCI_ML_DBS, 'spambase/spambase.data')
        data = pd.read_csv(url, header=None)
...
def parse_path():
    ...
    parser.add_argument('datasets', help='The type of datasets to download.')
    parser.add_argument('path', help='The relative or absolute path of the database.')
    parser.add_argument('db_name', help='The name of the database.')
    parsed_args = parser.parse_args()
    return parsed_args.datasets, abspath(parsed_args.path), parsed_args.db_name


def check_datasets(datasets):
    """Validate input and return datasets class."""
    mapping = {'imbalanced_data': ImbalancedDatasets, 'balanced_data': BalancedDatasets}
...
if __name__ == '__main__':
    ...
    # Parse arguments
    datasets, path, db_name = parse_path()

    # Check datasets
    datasets = check_datasets(datasets)
    
    # Download and save datasets
    datasets.download().save(path, db_name)
