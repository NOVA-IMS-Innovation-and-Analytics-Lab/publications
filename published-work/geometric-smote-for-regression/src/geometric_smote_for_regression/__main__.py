"""geometric-smote-for-regression file for ensuring the package is executable
as `geometric-smote-for-regression` and `python -m geometric_smote_for_regression`
"""
import importlib
