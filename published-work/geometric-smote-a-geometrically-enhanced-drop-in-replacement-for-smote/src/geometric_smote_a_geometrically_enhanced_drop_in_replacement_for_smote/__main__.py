"""geometric-smote-a-geometrically-enhanced-drop-in-replacement-for-smote file for ensuring the package is executable
as `geometric-smote-a-geometrically-enhanced-drop-in-replacement-for-smote` and `python -m geometric_smote_a_geometrically_enhanced_drop_in_replacement_for_smote`
"""
import importlib
