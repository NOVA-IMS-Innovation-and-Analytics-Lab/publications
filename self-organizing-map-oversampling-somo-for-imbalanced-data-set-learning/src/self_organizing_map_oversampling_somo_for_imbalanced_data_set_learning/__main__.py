"""self-organizing-map-oversampling-somo-for-imbalanced-data-set-learning file for ensuring the package is executable
as `self-organizing-map-oversampling-somo-for-imbalanced-data-set-learning` and `python -m self_organizing_map_oversampling_somo_for_imbalanced_data_set_learning`
"""
import importlib
