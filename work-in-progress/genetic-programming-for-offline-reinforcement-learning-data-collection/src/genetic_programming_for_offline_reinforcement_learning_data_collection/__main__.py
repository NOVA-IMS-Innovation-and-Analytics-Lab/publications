"""genetic-programming-for-offline-reinforcement-learning-data-collection file for ensuring the package is executable
as `genetic-programming-for-offline-reinforcement-learning-data-collection` and `python -m genetic_programming_for_offline_reinforcement_learning_data_collection`
"""
import importlib
