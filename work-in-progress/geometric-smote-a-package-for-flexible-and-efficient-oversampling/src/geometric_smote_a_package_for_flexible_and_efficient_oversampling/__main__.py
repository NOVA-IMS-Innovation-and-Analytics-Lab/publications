"""geometric-smote-a-package-for-flexible-and-efficient-oversampling file for ensuring the package is executable
as `geometric-smote-a-package-for-flexible-and-efficient-oversampling` and `python -m geometric_smote_a_package_for_flexible_and_efficient_oversampling`
"""
import importlib
