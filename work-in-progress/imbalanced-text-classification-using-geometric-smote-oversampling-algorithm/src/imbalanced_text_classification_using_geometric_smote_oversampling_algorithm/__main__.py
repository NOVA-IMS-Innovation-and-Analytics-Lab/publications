"""imbalanced-text-classification-using-geometric-smote-oversampling-algorithm file for ensuring the package is executable
as `imbalanced-text-classification-using-geometric-smote-oversampling-algorithm` and `python -m imbalanced_text_classification_using_geometric_smote_oversampling_algorithm`
"""
import importlib
