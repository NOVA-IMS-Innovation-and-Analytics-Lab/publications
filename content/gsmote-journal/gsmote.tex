...
results are analysed, by applying various statistical tests, to establish their
...
every head row/.style={before row=\toprule, after row=\midrule\endhead},
every last row/.style={after row=\bottomrule \caption{Optimal configuartion frequency for the three G-SMOTE cases.}}
]
