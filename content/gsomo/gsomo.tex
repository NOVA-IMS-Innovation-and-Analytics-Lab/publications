...
\begin{figure}[H]
	...
	\captionbelow{SMOTE Algorithm, inspired by \cite{Schubach2017}}
	\label{fig:Schubach}
\end{figure}
...
\begin{figure}[H]
	...
	\captionbelow{Challenging data formations, inspired by \cite{Sez2016}.}
	\label{fig:Sez}
\end{figure}
...
\begin{figure}[H]
	...
	\captionbelow{Shortcomings of SMOTE, inspired by \cite{Douzas2017}}
\end{figure}
...
\begin{figure}[H]
	...
	\captionbelow{Synthetic data generation based on a geometric region, inspired by \cite{Douzas2019}}
	\label{fig:GSMOTE}
\end{figure}
...
\begin{figure}[H]
	...
	\captionbelow{Overview of identified filtered clusters and neighboring relations, inspired by \cite{Douzas2017}}
...
\begin{figure}[H]
	...
	deformation, inspired by \cite{Douzas2017}}
