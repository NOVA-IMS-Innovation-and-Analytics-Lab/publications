...
\newenvironment{myfont}{\fontfamily{lmr}\selectfont}{\par}
\DeclareTextFontCommand{\headingFont}{\myfont}
\pdfoutput=1

\title{\headingFont{\textbf{G-SOMO: An Oversampling Approach based on Self-Organized Map Oversampling and Geometric SMOTE }}}

% G-SOMO: An informed Oversampling Approach leveraging a geometric extension of SMOTE 
...
\headingFont{\section{\headingFont{Related Work}}}
...
\headingFont{\section{\headingFont{Motivation}}}
...
\headingFont{\section{\headingFont{Proposed Method}}}
...
\headingFont{\subsection{\headingFont{G-SOMO Algorithm}}}
...
\headingFont{\subsection{\headingFont{Explanation of G-SOMO}}}
...
\begin{figure}[H]
	...
	\captionbelow{Constructing the geometric region, based on the unit hyper sphere, truncation and deformation, inspired by \cite{Douzas2017B}}
...
\headingFont{\section{\headingFont{Research Methodology}}}
...
\headingFont{\subsection{\headingFont{Metrics}}}
...
\headingFont{\subsection{\headingFont{Oversampling Methods}}}
...
\headingFont{\subsection{\headingFont{Classifiers}}}
...
\end{itemize}
\headingFont{\subsection{\headingFont{Datasets}}}
...
\headingFont{\subsection{\headingFont{Experimental Framework}}}
...
\headingFont{\section{\headingFont{Experimental Results}}}
...
\newpage
\headingFont{\section{\headingFont{Conclusion}}}
...
\newpage
\headingFont{\bibliography{References}}
