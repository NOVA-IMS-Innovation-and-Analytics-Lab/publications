...
\begin{table}[H]
	\centering
	\csvautobooktabular{./resources/cross_val_scores.csv}
	\caption{\label{tab:mean_cross_val}Results for cross validation scores 
		of oversamplers (B-SMOTE correspondents to Borderline SMOTE)}
\end{table}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{./resources/model_ranking.csv}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{./resources/mean_diff_scores.csv}
