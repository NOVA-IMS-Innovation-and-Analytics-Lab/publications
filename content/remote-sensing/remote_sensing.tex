...
\todo{missing citation} algorithm was selected. Out of the rule-based learning
methods, the decision tree classifier (DT) \todo{missing citation} was chosen.
Two ensemble learning methods were chosen: Gradient boosting classifier
\todo{missing citation} and Random Forest classifier. Finally, the logistic
regression classifier \todo{missing citation} was selected amongst the
