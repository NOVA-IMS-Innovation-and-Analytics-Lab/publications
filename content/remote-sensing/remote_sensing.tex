...
\begin{table}[H]
	\centering
	\csvautobooktabular{./resources/mean_sem_scores.csv}
...
\begin{table}[H]
	\centering
	\csvautobooktabular{./resources/mean_sem_ranking.csv}
	\caption{\label{tab:rankings} Results for mean ranking of oversamplers}
\end{table}

\begin{table}[H]
	\centering
	\csvautobooktabular{./resources/mean_sem_perc_diff_scores.csv}
