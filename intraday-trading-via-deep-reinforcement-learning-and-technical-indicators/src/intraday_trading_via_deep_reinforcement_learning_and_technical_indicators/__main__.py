"""intraday-trading-via-deep-reinforcement-learning-and-technical-indicators file for ensuring the package is executable
as `intraday-trading-via-deep-reinforcement-learning-and-technical-indicators` and `python -m intraday_trading_via_deep_reinforcement_learning_and_technical_indicators`
"""
import importlib
