import pandas as pd
import pytest
from improving_the_quality_of_predictive_models_in_small_data_gsdot_a_new_algorithm_for_generating_synthetic_data.pipelines.data_science.nodes import split_data
