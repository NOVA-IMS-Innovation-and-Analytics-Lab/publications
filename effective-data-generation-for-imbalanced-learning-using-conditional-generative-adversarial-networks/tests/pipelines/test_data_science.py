import pandas as pd
import pytest
from effective_data_generation_for_imbalanced_learning_using_conditional_generative_adversarial_networks.pipelines.data_science.nodes import split_data
