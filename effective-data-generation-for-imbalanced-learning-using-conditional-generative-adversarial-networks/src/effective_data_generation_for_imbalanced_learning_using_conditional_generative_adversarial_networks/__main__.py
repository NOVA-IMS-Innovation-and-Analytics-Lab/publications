"""effective-data-generation-for-imbalanced-learning-using-conditional-generative-adversarial-networks file for ensuring the package is executable
as `effective-data-generation-for-imbalanced-learning-using-conditional-generative-adversarial-networks` and `python -m effective_data_generation_for_imbalanced_learning_using_conditional_generative_adversarial_networks`
"""
import importlib
